...
public class TXTCommentAnalyzer {
	...
	public static String ROOTPATH = PropertiesUtil.getProperty("mysql.data.DataSource.rootPath","commentData/");
	public static String DEFAULTPATH = ROOTPATH+PropertiesUtil.getProperty("mysql.data.analysis.TXTCommentAnalyzer.classifiedCommentPath","CLASSIFIED");
	public static String DEFAULTSPLITER = PropertiesUtil.getProperty("mysql.data.analysis.TXTCommentAnalyzer.commentSpliter","##**##");;
	/**
	 * 抽取模板策略的严格级别：
